...
const TableKategori = ({ data }) => {
  ...
  const onDelete = () => {
    del( `https://6486e617beba6297278f6c94.mockapi.io/kategori/${selectedId}`)
      .then(() => {
        openTerhapusModal();
      })
      .catch((error) => {
              ...
              <tbody className={styles.tbody} id="tbody">
                {currentItems?.map((item) => (
                  <tr className={styles.tableRow} key={item.id}>
                    <td className="p-3" onClick={() => navigate(`/kategori/detail/${item.id}`)}>{item.namaKategori}</td>
                    <td
                      className="p-3"
                      style={{
                        maxWidth: "400px",
                    ...
                    <td className="p-3">
                      ...
                      <img
                        ...
                        onClick={() =>  {
                          ...
                          del(`https://6486e617beba6297278f6c94.mockapi.io/kategori/${item.id}`);
                        }}
                      />
                    </td>
                  </tr>
